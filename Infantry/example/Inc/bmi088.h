...
class Bmi088 : public infantry::IMU {
...
private:
    infantry::SpiDevice *_spi{nullptr};
    infantry::GpioDevice *_accel_start{nullptr};
    infantry::GpioDevice *_gyro_start{nullptr};
...
public:
    friend class GimbalIns;

    Bmi088(infantry::SpiDevice *spi, infantry::GpioDevice *accel_start, infantry::GpioDevice *gyro_start);
