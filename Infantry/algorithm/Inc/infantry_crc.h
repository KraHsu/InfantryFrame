 ...
 * @LastEditTime: 2024-01-23 15:51:08
...
uint8_t CRC_GetCRC8CheckSum(uint8_t *pchMessage, uint32_t dwLength, char ucCRC8);

uint32_t CRC_VerifyCRC8CheckSum(uint8_t *pchMessage, uint32_t dwLength);
